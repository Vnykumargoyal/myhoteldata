...
const IndifiErrorPage = () => {
  ...
  useEffect(() => {
    pushClevertapEvent(CLEVERTAP_EVENTS.PAGE_LOADS.INDIFI_BRE_ERROR_PAGE);
  }, []);
    ...
    if (eligibilityResponse) {
      ...
      if (eligibilityResponse.data) {
        ...
        pushClevertapEvent(CLEVERTAP_EVENTS.CTA_CLICKS.OFFLINE_WEBHOOK_ERROR_CTA, {
          page_name: 'TL_indifi_bre_rejected_page', journey: 'reset_journey',
        });
...
export default IndifiErrorPage;

...
import { ACTIVE_LOAN_ID, FIRST_TIME_LOGIN, clearCreditStorage } from '../../../../config/auth';
...
const OfferExpiedPage = () => {
  ...
  useEffect(() => {
    pushClevertapEvent(CLEVERTAP_EVENTS.PAGE_LOADS.OFFER_EXPIRED_PAGE);
  }, []);
      ...
      cusJourney({
        data: {
          ...
          data: {
            ...
            referenceCode: data?.referralCodeValue || null,
          },
        },
      });
    }
  ...
  return (
    <Wrapper
      ...
      //   pushClevertapEvent(CLEVERTAP_EVENTS.CTA_CLICKS.OFFER_EXPIRED_CTA, {
      //     page_name: 'offer_expired_page', offered: 'expired',
      //   });
      // }}
    >
      <CommonErrorPage
        // titelImg
        title={CONSTANTS.OFFER_EXPIRED}
        heading={CONSTANTS.OFFER_NO_LONGER}
        img={IMAGE_URLS.OFFER.OFFER_NOT_AVAL}
        bottomHeading={CONSTANTS.OFFER_NOT_UPDATED}
      />
      <Container>
        <Button
...
export default OfferExpiedPage;

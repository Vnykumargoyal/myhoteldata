...
export default () => {
  ...
  const optionsColumn = {
    ...
    colors: ["#cfe4ff", color.primary], // Colors for Food and Room columns
      ...
      <Container className={classes.cont}>
        ...
        <Box mt={4}>
          <Typography component="p" className={classes.heading}>
            {CONSTANTS.TOTAL_REVENUE_HEADING}
          </Typography>
        </Box>
        <Box mt={2}>
        ...
        <Box mt={3}>
          <Typography component="p" className={classes.heading}>
            {CONSTANTS.REVENUE_DETAILS_HEADING}
          </Typography>
        </Box>
        <Box mt={2}>
        ...
        <Box mt={3}>
          <Typography component="p" className={classes.heading}>
            {CONSTANTS.REVENUE_BRACKUP_HEADING}
          </Typography>
        </Box>
        <Box mt={2}>
        ...
        <Box mt={3}>
          <Typography component="p" className={classes.heading}>
            {CONSTANTS.OCCUPANCY_DETAILS_HEADING}
          </Typography>
        </Box>
        <Box mt={2}>
          <TabView onChange={setOccupancyDetail} emiTenure={occupancyDetail}  tenures={TOTAL_Detail}/>
        </Box>
        <Box mt={2} mb={3}>
          {occupancyDetail === 'Monthly' && (
            <>
              <Box mt={1}>
              <Chart
                  chartType="ColumnChart"
                  data={customColumnChartMonthly()}
                  options={{ ...optionsColumn, title: occupancyDetail }}
                  width={"100%"}
                  height={"300px"}
                />
              </Box>
